...
FRAME_CT = "e0f2ae2cf99076b0c87847f9b6d5bb49b07f5ce178"
FRAME_TAG = "c90f32a1d12ec9080ea5bb6d9e7ed7b9"
PLAINTEXT = b'{"n":29,"s":12,"m":1}'
...
def test_envelope_matches_firmware():
    ...
    ciphertext, tag = crypto._xchacha_seal(
        crypto.derive_field_key(), nonce, bytes([29]), PLAINTEXT)
